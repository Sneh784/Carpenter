...
import ContactData from '../../datafile/ContactData';
      ...
      <div className={styles.left}>
        {ContactData.map((contact, index) => (
          <div key={index} className={styles.contactCard}>
            <h2>{contact.title}</h2>
            <h1>{contact.logo}<FaFacebook color='chocolate' size={40} className={styles.logo}/>
            <FaInstagram  color='chocolate' size={40} className={styles.logo} />
            <FaYoutubeSquare color='chocolate' size={40} className={styles.logo}/>
            <BsLinkedin color='chocolate' size={36} className={styles.logo}/> </h1>
            {/* <p>{contact.para}</p> */}

            <div className={styles.ContactAdress}>
              <MdLocationPin color='chocolate' size={30} className={styles.locationicon} />
              <h3>Address:</h3>
            </div>
            <ul>
            ...
            <div className={styles.MailIcon}>
              <MdEmail color="chocolate" size={30} className={styles.mailIcon} />
              <h3>Mail ID:</h3>
              {contact.Mail_ID}
            </div>

            <div className={styles.ContactNo}>
              <FaPhone color="chocolate" size={30} className={styles.contacticon} />
              <h3>Contact:</h3>
              {contact.Contact_Us}
            </div>
